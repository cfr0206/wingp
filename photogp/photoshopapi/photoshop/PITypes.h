...
#ifndef Macintosh
#if (defined(macintosh) || defined(__powerc) || defined(__MC68K__) || defined(__MACH__) || defined (__POWERPC__) || defined(THINK_C)) && !MSWindows
#define Macintosh 1
#else
#define Macintosh 0
#endif
...
/** Point x,y defined with \c double */
...
/** Rectangle defined with \c double. */
...
/** 
* Affine matrix defined with \c double. This is a 3x3 matrix with the following
* structure:
@verbatim
|	xx		xy		0	|
|	yx		yy		0	|
