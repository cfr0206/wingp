...
typedef struct FormatRecord
	...
	int32				dataFork;		/**< The reference number for the data fork of the file 
	...
	int32				rsrcFork;		/**< The reference number for the resource fork of the file 
										 to be read during the read sequence or written during the 
										 write sequence. During the options and estimate selector
	...
	SPPlatformFileSpecificationW *fileSpec2;	/**< Unicode replacement for @ref fileSpec. */
	...
	RenderRecord	*renderRecord;		/**< Data for Plugin Rendered Layers */
	...
	//@{
	char		reserved [39]; 					/**< Reserved for future use. Set to zero. */
	//@}
